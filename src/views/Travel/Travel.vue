<template>
  <div class="container">
    <div class="Top">
      <el-form style="height: 100px;position: absolute;top: 100px;left: 360px;">
        <el-form-item>
      ...
      <div class="left">
        <div class="display_big">
          <el-carousel trigger="click" height="410px" :interval="5000" direction="vertical">
      ...
      <el-row>
        <el-col :span="4">
          <div class="grid-content-fenlei">
            <div class="fenlei">
              分类 <i class="el-icon-caret-bottom" style="text-align: right;" @click="fenleiShow"></i>
            </div>
            <transition name="el-zoom-in-top">
              <el-card v-show="fenleishow" class="transition-box">
                ...
                <el-checkbox-group v-model="checkedOptions" @change="handleCheckedOptionsChange">
                  <el-checkbox v-for="fenlei in op" :label="fenlei" :key="fenlei">{{fenlei}}</el-checkbox>
                </el-checkbox-group>
              </el-card>
            </transition>
          </div>
